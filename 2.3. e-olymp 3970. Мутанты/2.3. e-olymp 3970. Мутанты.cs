...
{
    internal class Program //by TheSkyMaks
    {
        private static int Binary_Search_Left(int[] arr, int left, int right, int key)
        ...
        private static int Binary_Search_Right(int[] arr, int left, int right, int key)
